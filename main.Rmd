...
Now we remove variables that are not statistically meaningful to the model.
...
```{r}
glm_predict_subs <- predict(model2, test_dummy_2, type = "response")

roc_curve <- roc(test_dummy_2$subscribed, glm_predict_subs)
