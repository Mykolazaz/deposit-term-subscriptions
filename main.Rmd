...
As the chart shows, students, of all jobs, were most likely to subscribe to a deposit (above 25%) with retired workers following second (around 25%).
...
Since we are dealing with financial data the are many exceptions (outliers) in the distributions of variables. Though the box plots do indicate that the median balance is higher for those who chose to subscribe.
...
The situation is practically the same with personal loans accept here only 16,1% of the clients had a personal loan. Clients that did not have a personal loan were 1,9 times as likely to subscribe than the clients without one.
...
By lowering the threshold down to 0.2, true positives are being recognized with 65,8% accuracy and the specificity is only lowered to 90,5%.
