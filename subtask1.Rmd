...
There are "unknown" values in the education variable. If we removed these "unknowns" we would risk causing further imbalance in the subscribed variable as only around 20% of clients decided to make a deposit subscription.
