...
Also, we'll choose another group of clients which have at least one loan with the bank and are at least of the mean age for the data set.

```{r}
withLoans <- bank_full %>% 
  filter((housing_loan == TRUE | personal_loan == TRUE) & age >= mean(age, na.rm = TRUE))
```
